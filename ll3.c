...
{  
    ...
    while(ch!=8)   
    {    
        printf("\n_______________________________________________LinkedList Menu_______________________________________________\n");    
        printf("\n1.Insert in the begining\n2.Insert at last\n3.Insert at any specified position\n4.Delete from Beginning\n5.Delete from last\n6.Delete node of a specified location\n7.Show\n8.Exit\n");          printf("\nEnter your choice:");
	scanf("\n%d",&ch);  
        switch(ch)  
...
{  
	...
	delete_begin();
	    ...
	    printf("\nInvalid node, list starts from 1st position");
    else{
    p=start;  
    for(i=0;i<loc-1;i++)  
    {  
